import{T as St}from"./TopWitge-74e60925.js";import{c as J,d as kt,e as Tt,f as Rt,r as Pt}from"./api-d8582572.js";import{n as K,r as R,q as Wt,A as h,az as Bt,aA as ge,aB as Lt,I as i,W as f,K as S,M as ee,L as me,aC as At,x as X,P as xe,aD as Et,B as Ve,aE as jt,a3 as It,U as Ot,aF as Mt,C as Ht,S as I,ac as Nt,N as Fe,aG as Dt,F as se,Q as Vt,T as Ft,ab as Ut,aH as Xt,J as F,X as Gt,aI as we,a0 as Ce,a1 as Kt,Z as ne,ag as Yt,a2 as Ee,V as je,ad as be,D as $e,ao as qt,ap as Jt,aJ as Zt,aK as Qt,aL as en,a6 as pe,aM as tn,o as U,d as Q,i as A,_ as nn,a as an,e as v,w as b,g as _,k as B,au as ve,c as he,aw as Z,l as rn}from"./index-a326bd32.js";import{A as on}from"./Add-270bce2a.js";import{a as Ie,c as sn,u as Te,o as ln,_ as dn}from"./Tooltip-08eec595.js";import{u as cn}from"./use-merged-state-78ce3c41.js";import{f as fn,_ as un,a as bn,b as pn}from"./Thing-4dfdc3b3.js";const vn=Ie(".v-x-scroll",{overflow:"auto",scrollbarWidth:"none"},[Ie("&::-webkit-scrollbar",{width:0,height:0})]),hn=K({name:"XScroll",props:{disabled:Boolean,onScroll:Function},setup(){const e=R(null);function t(s){!(s.currentTarget.offsetWidth<s.currentTarget.scrollWidth)||s.deltaY===0||(s.currentTarget.scrollLeft+=s.deltaY+s.deltaX,s.preventDefault())}const a=Wt();return vn.mount({id:"vueuc/x-scroll",head:!0,anchorMetaName:sn,ssr:a}),Object.assign({selfRef:e,handleWheel:t},{scrollTo(...s){var c;(c=e.value)===null||c===void 0||c.scrollTo(...s)}})},render(){return h("div",{ref:"selfRef",onScroll:this.onScroll,onWheel:this.disabled?void 0:this.handleWheel,class:"v-x-scroll"},this.$slots)}});var gn=/\s/;function mn(e){for(var t=e.length;t--&&gn.test(e.charAt(t)););return t}var xn=/^\s+/;function _n(e){return e&&e.slice(0,mn(e)+1).replace(xn,"")}var Oe=0/0,yn=/^[-+]0x[0-9a-f]+$/i,wn=/^0b[01]+$/i,Cn=/^0o[0-7]+$/i,$n=parseInt;function Me(e){if(typeof e=="number")return e;if(Bt(e))return Oe;if(ge(e)){var t=typeof e.valueOf=="function"?e.valueOf():e;e=ge(t)?t+"":t}if(typeof e!="string")return e===0?e:+e;e=_n(e);var a=wn.test(e);return a||Cn.test(e)?$n(e.slice(2),a?2:8):yn.test(e)?Oe:+e}var zn=function(){return Lt.Date.now()};const ze=zn;var Sn="Expected a function",kn=Math.max,Tn=Math.min;function Rn(e,t,a){var d,s,c,l,u,x,y=0,w=!1,z=!1,$=!0;if(typeof e!="function")throw new TypeError(Sn);t=Me(t)||0,ge(a)&&(w=!!a.leading,z="maxWait"in a,c=z?kn(Me(a.maxWait)||0,t):c,$="trailing"in a?!!a.trailing:$);function k(r){var p=d,W=s;return d=s=void 0,y=r,l=e.apply(W,p),l}function P(r){return y=r,u=setTimeout(O,t),w?k(r):l}function L(r){var p=r-x,W=r-y,H=t-p;return z?Tn(H,c-W):H}function E(r){var p=r-x,W=r-y;return x===void 0||p>=t||p<0||z&&W>=c}function O(){var r=ze();if(E(r))return j(r);u=setTimeout(O,L(r))}function j(r){return u=void 0,$&&d?k(r):(d=s=void 0,l)}function M(){u!==void 0&&clearTimeout(u),y=0,d=x=s=u=void 0}function V(){return u===void 0?l:j(ze())}function C(){var r=ze(),p=E(r);if(d=arguments,s=this,x=r,p){if(u===void 0)return P(x);if(z)return clearTimeout(u),u=setTimeout(O,t),k(x)}return u===void 0&&(u=setTimeout(O,t)),l}return C.cancel=M,C.flush=V,C}var Pn="Expected a function";function Se(e,t,a){var d=!0,s=!0;if(typeof e!="function")throw new TypeError(Pn);return ge(a)&&(d="leading"in a?!!a.leading:d,s="trailing"in a?!!a.trailing:s),Rn(e,t,{leading:d,maxWait:t,trailing:s})}const Wn=i("icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
